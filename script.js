...
class ListingManager {
    ...
    createListingCard(listing) {
        ...
        image.onerror = () => {
            image.src = 'https://via.placeholder.com/300?text=Image+Not+Available';
        };
    ...
    getListingImage(listing) {
        return idToImageUrlMap[listing.id] || 'https://via.placeholder.com/300?text=Image+Not+Available';
    }
